  ...
  const share = () => {
    if (navigator.share) {
      navigator
        .share({
          title: "Sismo",
          text: `Visitez Sismo ! Un outil pour connaître les zones de neige, de vent et de sismicité en France (y compris les DROM-COM).
    ...
    <div>
      ...
      >
        <ListItem className={classes.ListItemHeader}>
          ...
          <h2 className={classes.h2} onClick={() => document.location.reload()}>
            Sismo
          </h2>
          <img
        ...
        <List className={classes.list}>
          ...
          {supportPWA ? (
            <ListItem button onClick={install}>
              ...
              <ListItemText
                primary={"Installer"}
                secondary={"Installer Sismo sur votre appareil"}
              />
            </ListItem>
          ) : (
            <div></div>
          ...
          {navigator.share ? (
            <ListItem button onClick={share}>
              ...
              <ListItemText
                primary={"Partager"}
                secondary={"Partager l'application autour de vous"}
              />
            </ListItem>
          ) : (
